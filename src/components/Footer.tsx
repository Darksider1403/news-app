                    ...
                    <div className="flex flex-wrap flex-row lg:justify-between -mx-3">
                        <div className="flex-shrink max-w-full w-full lg:w-2/5 px-3 lg:pr-16">
                            <div className="flex items-center mb-2">
                                <span
                                    className="text-3xl leading-normal mb-2 font-bold text-gray-100 mt-2">TailNews</span>
                                {/* <img src="src/img-min/logo.png" alt="LOGO"> */}
                            </div>
                            <p>Tailwind News Template for building a great newspaper, magazine, and news portal.</p>
